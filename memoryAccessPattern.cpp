...
// Globals
/////////////////////////////////////////////////////////////////
unsigned long long length = (unsigned long long)2147483648/(unsigned long long)2;
unsigned long long MAXLENGTH = 2147483648/ (unsigned long long) 2;
cl_float * pX   = NULL;
cl_float * pY   = NULL;
cl_float a      = 2.f;
...
string kernelStr      =
    ...
    "     uint index = gid * stride % arraySize; \n"
