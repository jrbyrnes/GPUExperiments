...
// Globals
/////////////////////////////////////////////////////////////////
unsigned long long length = (unsigned long long)2147483648*(unsigned long long)256;
int MAXLENGTH = 8192*8;
cl_float * pX   = NULL;
cl_float * pY   = NULL;
cl_float a      = 2.f;
...
string kernelStr      =
    ...
    "     }\n"
    "     else {\n"
    "      y[gid] = 2 * x[gid*2%16384] + y[gid];\n"
    "     }\n"
    "     if (gid % 2 == 0) {\n"
    "       y[gid] = 3 * x[gid+512%16384] + y[gid];\n"
    "     }\n"
    "     else {\n"
    "      y[gid] = 2 * x[gid*1024%16384] + y[gid];\n"
    "     }\n"
    "   }\n"
    "}\n";
...
int main(int argc, char * argv[])
{
  ...
  //int inputStride = std::stoi(inputString);
  //printf("implementing lds stride of %d", inputStride);
